...
namespace MagicVilla_Web.Controllers
{
    ...
    {
        private readonly IUsuarioService _usarioService;
        ...
        {
            var response = await _usarioService.Login<APIResponse>(modelo);
        ...
        {
            var response = await _usarioService.Registrar<APIResponse>(modelo);
